...
export default function Hero({ t }: HeroProps) {
  return (
    <section className="pt-32 pb-0 px-6 overflow-hidden" style={{ background: 'linear-gradient(160deg, #eef0f4 0%, #e8edf5 50%, #ffffff 100%)' }}>
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="flex items-center justify-center gap-4 flex-wrap mb-6">
          <a href="https://app.planivoapp.com/register" className="bg-blue-600 text-white font-bold px-10 py-4 rounded-2xl hover:bg-blue-700 transition-all text-base" style={{ boxShadow: '0 6px 24px rgba(37,99,235,0.4)' }}>
            {t.hero.cta_primary} →
          </a>
          <a href="#how-it-works" className="text-slate-600 font-semibold px-8 py-4 rounded-2xl border-2 border-slate-200 hover:border-slate-300 hover:bg-white transition-all text-base">
