  ...
  return (
    <section className="py-24 px-6 bg-white">
      <div className="max-w-3xl mx-auto text-center">
        <div
          className="rounded-3xl bg-blue-600 px-12 py-16"
          style={{ boxShadow: '0 20px 60px 0 rgba(37,99,235,0.3)' }}
        >
          ...
          <p className="text-blue-200 text-lg mb-8">
            ...
            className="inline-block bg-white text-blue-600 font-semibold px-8 py-4 rounded-xl hover:bg-blue-50 transition-colors text-base"
